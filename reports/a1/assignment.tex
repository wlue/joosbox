...
\begin{document}
  ...
  Joosbox uses an LR(1) grammar to parse Joos 1W. This grammar is based on the
  grammar for Java 1 itself, with numerous tokens removed and altered to match
  Joos 1W. The provided {\tt jlalr1.java} program for constructing a parse
  table was used to create the {\tt joos1w.lr1} file, used at runtime by
  Joosbox to parse the language.
